...
def getDedupedBundle(db, extractor, targetEntity, theType, opts={"query": None}, sess=None):
    ...
    if 'ontology_labels' in name:
        ...
        ontology_labels = ['answer', 'arbitration motion', 'arrest', 'bench trial', 'bilateral', 'brief', 'complaint', 'consent decree', 'consent judgment', 'default judgment resolution', 'dismiss with prejudice', 'dismiss without prejudice', 'dismissing motion', 'error', 'findings of fact', 'granting motion for summary judgment', 'granting motion to dismiss', 'indictment', 'information', 'judgment', 'jury trial', 'minute entry', 'motion for default judgment', 'motion for habeas corpus', 'motion for judgment as a matter of law', 'motion for judgment on the pleadings', 'motion for judgment', 'motion for settlement', 'motion for summary judgment', 'motion for time extension', 'motion to certify class', 'motion to dismiss', 'motion to remand', 'motion to seal', 'motion', 'notice of appeal', 'notice of consent', 'notice of dismissal', 'notice of motion', 'notice of removal', 'notice of settlement', 'notice of voluntary dismissal', 'notice', 'opening - complaint', 'opening - indictment', 'opening - information', 'opening - notice of removal', 'order', 'outcome - bench trial', 'outcome - consent decree', 'outcome - default judgment', 'outcome - jury trial', 'outcome - remand', 'outcome - rule 12b', 'outcome - rule 68', 'outcome - settlement', 'outcome - summary judgment', 'outcome - voluntary dismissal', 'petition for habeas corpus', 'petition', 'proposed', 'remand resolution', 'response', 'rule 68 resolution', 'settlement agreement', 'stipulation for judgment', 'stipulation for settlement', 'stipulation of dismissal', 'stipulation', 'summons', 'transfer', 'transferred entry', 'trial', 'unopposed', 'verdict', 'waiver of indictment', 'waiver', 'warrant', 'voluntary dismissal resolution', 'agreement reached', 'inbound transfer', 'outcome - sentence', 'settlement reached', 'motion for voluntary dismissal', 'outcome - outbound transfer', 'opening - inbound transfer', 'plea', 'case opened in error', 'plea agreement', 'case dismissed', 'outbound transfer', 'outcome - other trial', 'outcome - voluntary dismissal (settlement)', 'not guilty plea', 'outcome - admin closing', 'guilty plea', 'sentence', 'opening - petition', 'consent judgment resolution', 'outcome - case dismissed', 'consent decree resolution']
